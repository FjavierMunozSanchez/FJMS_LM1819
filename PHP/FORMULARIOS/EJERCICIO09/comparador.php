...
$num1 = trim(htmlspecialchars($_REQUEST[num1], END_QUOTES, "UTF-8"));
$num2 = trim(htmlspecialchars($_REQUEST[num2], END_QUOTES, "UTF-8"));
$num3 = trim(htmlspecialchars($_REQUEST[num3], END_QUOTES, "UTF-8"));
